...
public class StringUtil {
	...
	/**
	 * ¹¦ÄÜËµÃ÷£ºÊµÏÖÅÐ¶Ï´«ÈëµÄ×Ö·û´®ÊÇ·ñÎª°üº¬httpµÄurlµØÖ·
	 */
	 ...
	 * @Description: »ñÈ¡Ëæ»úµÄµç»°ºÅÒÔ13¿ªÍ·
	 * @return
	 * @return: String
	 */
